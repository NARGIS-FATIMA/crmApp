...
public class CreatingNewCampaignTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		String actCampName = cip.getHeaderTxt().getText();
		if(actCampName.contains(CampignName)) {
			System.out.println(CampignName+"is verified===Pass");
		}else {
			System.out.println(CampignName+"is not verified===FAIL");
		}
